...
public class ArbolExpresionGrafico extends JPanel 
{
    ...
    private FontMetrics fm = null;
     ...
     //El constructor permite inicializar los atributos de la clase ArbolExpresionGrafico y llama al método repaint(), que es el encargado de pintar el Arbol.
    ...
    /**
     * Calcula las posiciones de los respectivos subárboles y de cada nodo que forma parte de ese subárbol, para conocer en que posición van a ir dibujados
    ...
    /**
     * Calcula la ubicación de cada nodo de cada subárbol y agrega cada nodo con un objeto de tipo Rectangule que tiene la ubicación y
     * la información específica de dónde va a ser dibujado.
     */
    ...
    // Dibuja el árbol teniendo en cuenta las ubicaciones de los nodos y los subárboles calculadas
